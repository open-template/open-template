...
import { ScllibServiceRest } from './scllib.service';
...
xdescribe('ScllibServiceRest', () => {
  let service: ScllibServiceRest;

  beforeEach(async () => {
    const module: TestingModule = await Test.createTestingModule({
      providers: [ScllibServiceRest],
    }).compile();

    service = module.get<ScllibServiceRest>(ScllibServiceRest);
  });
